...
export default function Signup() {
  ...
  return (
    <div style={{
      ...
      backgroundImage: 'radial-gradient(ellipse at 50% 0%, rgba(232,197,71,0.07) 0%, transparent 55%), radial-gradient(ellipse at 20% 100%, rgba(232,197,71,0.04) 0%, transparent 50%)',
    }}>
